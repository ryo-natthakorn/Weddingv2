          ...
          <div style={{ borderRadius: 20, overflow: "hidden", boxShadow: "0 16px 50px rgba(27,74,92,0.12)", background: "rgba(255,248,240,0.55)", border: "1px solid rgba(138,107,75,0.18)" }}>
            <div style={{ position: "relative" }}>
              ...
              <div style={{ position: "absolute", bottom: 18, left: 20, right: 20 }}>
                <h2 style={{ fontFamily: "'TT Interphases', sans-serif", fontSize: "min(2.4rem, calc((100vw - 88px) / 15.9))", fontWeight: 600, color: "#FFF8EE", lineHeight: 1.15, whiteSpace: "nowrap", textShadow: "0 2px 12px rgba(0,0,0,0.4)" }}>{t.map_title}</h2>
              </div>
            </div>
