      ...
      {!leaving && (
        ...
        >
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 32px" }}>
            ...
            >
              <img src={pnLogo} alt="PN" style={{ width: "min(110px,28vw)", height: "auto", display: "block" }} />
            </motion.div>
            ...
            >
              ...
              >
                ...
                {/* Arrows hint — fade out as ring moves */}
                ...
                <motion.div
                  ...
                  style={{
                    position: "absolute",
                    left: `calc(${pos}% * (1 - 72 / var(--track-w, 300)) )`,
                    top: 0, bottom: 0,
                    width: 72, height: 72,
