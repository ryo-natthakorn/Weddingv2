  ...
  return (
    <section
      ...
      style={{
        position: "relative",
        background:
          "linear-gradient(180deg, #F8F1E6 0%, #F2E8D2 50%, #EEE2C8 100%)",
        padding: "110px 24px 100px",
        textAlign: "center",
        overflow: "hidden",
      }}
    >
      {/* Watercolor texture layers — homey, hand-painted feel */}
      ...
      <WatercolorFlower
        size={38}
        style={{ position: "absolute", top: 90, left: 28, opacity: 0.55, zIndex: 2 }}
      />
      <WatercolorFlower
        size={32}
        color="#A8B080"
        centerColor="#7A8A5A"
        style={{ position: "absolute", top: 130, right: 36, opacity: 0.5, zIndex: 2 }}
      />
      <WatercolorFlower
        size={28}
        color="#D4A574"
        style={{ position: "absolute", bottom: 110, left: 50, opacity: 0.5, zIndex: 2 }}
      />

      <div style={{ position: "relative", zIndex: 3 }}>
        {/* PN Logo — with mix-blend to remove white background */}
        <motion.div
