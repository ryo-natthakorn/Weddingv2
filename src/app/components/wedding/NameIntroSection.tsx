...
import { useReveal, Divider, BotanicalBorder, COLORS } from "./shared";
...
export function NameIntroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <img src={pnLogo} alt="PN" style={{ width: "min(90px,22vw)", height: "auto" }} />
      </motion.div>
      ...
      >
        ...
        <img src={ringImg} alt="ring" style={{ width: 44, height: 44, objectFit: "contain", filter: "drop-shadow(0 2px 6px rgba(27,74,92,0.18))" }} />
        <div style={{ flex: 1, maxWidth: 80, height: 1, background: "rgba(138,112,48,0.3)" }} />
      </motion.div>
