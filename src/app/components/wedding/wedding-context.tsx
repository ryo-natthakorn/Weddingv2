...
export const translations = {
  EN: {
    ...
    program: [
      { time: "16:09", title: "Engagement" },
      { time: "17:00", title: "Welcome & Photos" },
      { time: "18:00", title: "Celebration" },
    ],
    direction_items: [
      { key: "car", title: "By Car", text: "Parking available for wedding guests" },
      { key: "mrt", title: "By MRT", text: "Pink Line · Ram Inthra Kor Mor 6 station (PK22)" },
      { key: "grab", title: "By Grab", text: "Search 'SailomSangdad Homey Studio'" },
    ],
    ...
    hashtag: "#PNEST221126",
    hashtag_sub: "Tag your photos with our hashtag 😁",
    ...
    dress_colors: [
      ...
      "Deep green", "Sage", "Forest green",
    ],
    rsvp_label: "RSVP",
    rsvp_title: "Will You Join Us?",
    rsvp_subtitle: "Kindly reply by 31 October 2026",
    ...
    song_title: "Pantika",
    song_dedication_lines: ["Ryo wrote this song for Panyee"],
    song_play: "Play song",
  ...
  TH: {
    ...
    program_label: "กำหนดการ",
    program: [
      { time: "16:09", title: "พิธีหมั้น" },
      { time: "17:00", title: "ลงทะเบียนและถ่ายภาพ" },
      { time: "18:00", title: "งานเลี้ยงฉลอง" },
    ],
    direction_items: [
    ...
    quote_line1: "“ความรักที่ท่านได้รับจากใครสักคนอย่างลึกซึ้ง มอบความเข้มแข็งให้แก่ท่าน",
    quote_line1_lines: ["“ความรักที่ท่านได้รับจากใครสักคนอย่างลึกซึ้ง", "มอบความเข้มแข็งให้แก่ท่าน"],
    quote_line2: "ส่วนความรักที่ท่านมอบให้ผู้อื่นอย่างลึกซึ้ง นำพาความกล้ามาสู่ท่าน”",
    quote_line2_lines: ["ส่วนความรักที่ท่านมอบให้ผู้อื่นอย่างลึกซึ้ง", "นำพาความกล้ามาสู่ท่าน”"],
    ...
    song_title: "Pantika",
    song_dedication_lines: ["เรียวแต่งเพลงนี้ให้ปันหยี"],
    song_play: "ฟังเพลง",
