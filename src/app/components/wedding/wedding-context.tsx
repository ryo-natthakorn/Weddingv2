...
export const translations = {
  EN: {
    ...
    map_hint: "Two fingers to explore · pinch to zoom",
    map_gesture_hint: "Use two fingers to move the map",
    map_venue_pin: "SailomSangdad Homey Studio",
    map_mrt_pin: "MRT Ram Inthra Kor Mor 6 (Pink Line)",
  ...
  TH: {
    ...
    map_hint: "สองนิ้วเพื่อสำรวจ · บีบเพื่อซูม",
    map_gesture_hint: "ใช้สองนิ้วเพื่อเลื่อนแผนที่",
    map_venue_pin: "บ้านสายลมแสงแดด",
    map_mrt_pin: "MRT รามอินทรา กม.6 (สายสีชมพู)",
