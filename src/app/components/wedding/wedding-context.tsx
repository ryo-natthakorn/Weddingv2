...
export const translations = {
  EN: {
    ...
    gift_description: "For anyone who would like to send us off on our honeymoon, you can leave a little something here.",
  ...
  TH: {
    ...
    rsvp_importance:
      "รบกวนแจ้งให้เราทราบ เพื่อที่เราจะได้ต้อนรับทุกท่านได้อย่างทั่วถึง",
    ...
    gift_description: "ใครอยากส่งเราสองคนไปฮันนีมูน ร่วมใส่ซองตรงนี้ได้เลยครับ",
    gift_tap: "แตะเพื่อร่วมใส่ซอง",
    gift_closing: "ขอบคุณที่ร่วมยินดีกับเราสองคน",
    gift_save: "บันทึก QR",
    gift_save_hint: "แล้วสแกนจากอัลบั้มรูปในแอปธนาคาร",
    song_title: "Pantika",
    song_dedication: "เรียวแอบแต่งเพลงนี้ให้หยี เพื่อเซอร์ไพรส์ตอนขอหยีแต่งงาน",
    song_play: "ฟังเพลง",
