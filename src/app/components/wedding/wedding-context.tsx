...
export const translations = {
  EN: {
    ...
    direction_items: [
      { key: "car", title: "By Car", text: "Parking available on site" },
  ...
  TH: {
    ...
    direction_items: [
      { key: "car", title: "เดินทางโดยรถยนต์", text: "มีที่จอดรถในงาน" },
      { key: "mrt", title: "โดย MRT", text: "สายสีชมพู สถานีรามอินทรา กม.6 (PK22)" },
    ...
    rsvp_guests: "จำนวนผู้มาร่วมงาน",
    rsvp_guests_help: "รวมผู้กรอกแบบฟอร์ม",
    rsvp_importance:
      "รบกวนแจ้งให้เราทราบ เพื่อเตรียมที่นั่งต้อนรับทุกคน",
    ...
    quote_line1: "“การได้เป็นคนที่ใครสักคนรักอย่างลึกซึ้ง ทำให้เราเข้มแข็ง",
    quote_line2: "ส่วนการรักใครสักคนอย่างลึกซึ้ง ทำให้เรากล้าหาญ”",
    ...
    song_title: "Pantika",
    song_dedication: "เรียวแอบแต่งเพลงนี้ให้หยีล่วงหน้า เพื่อเซอร์ไพรส์ในวันขอแต่งงาน",
