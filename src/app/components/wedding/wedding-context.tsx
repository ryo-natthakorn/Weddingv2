...
export const translations = {
  EN: {
    ...
    direction_items: [
      { key: "car", title: "By Car", text: "Free parking on site" },
  ...
  TH: {
    ...
    direction_items: [
      { key: "car", title: "เดินทางโดยรถยนต์", text: "มีที่จอดรถฟรีในงาน" },
    ...
    dress_desc: "ขอเชิญแต่งกายด้วยโทนสีน้ำตาล ทอง เหลือง ครีม เขียว",
    dress_colors: [
    ...
    rsvp_yes: "ยินดีไปร่วมงาน",
    rsvp_no: "ขออภัย ไม่สะดวกไปร่วมงาน",
    rsvp_guests: "จำนวนผู้เข้าร่วม",
    rsvp_guests_help: "รวมตัวคุณด้วย",
    rsvp_importance:
      "การตอบรับของคุณช่วยให้เราเตรียมงานได้พอดี",
    ...
    song_title: "Pantika",
    song_dedication: "เพลงรักที่ผมแต่งให้เธอในวันขอแต่งงาน",
